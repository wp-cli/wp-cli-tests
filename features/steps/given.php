...
$steps->Given(
	"/^a WP (install|installation) in '([^\s]+)'$/",
...
$steps->Given(
	'/^a WP (install|installation) with Composer$/',
	function ( $world ) {
...
$steps->Given(
	"/^a WP (install|installation) with Composer and a custom vendor directory '([^\s]+)'$/",
...
$steps->Given(
	'/^a WP multisite (subdirectory|subdomain)?\s?(install|installation)$/',
...
$steps->Given(
	"/^a PHP built-in web server to serve '([^\s]+)'$/",
